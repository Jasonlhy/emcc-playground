...
var ASM_CONSTS = {
  ...
  function _emscripten_get_preloaded_image_data(path, w, h) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(7, 1, path, w, h);
  ...
  function _emscripten_get_preloaded_image_data_from_FILE(file, w, h) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(8, 1, file, w, h);
  ...
  function _environ_get(__environ, environ_buf) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(9, 1, __environ, environ_buf);
  ...
  function _environ_sizes_get(penviron_count, penviron_buf_size) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(10, 1, penviron_count, penviron_buf_size);
  ...
  function _fd_close(fd) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(11, 1, fd);
  ...
  function _fd_seek(fd, offset_low, offset_high, whence, newOffset) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(13, 1, fd, offset_low, offset_high, whence, newOffset);
...
var proxiedFunctionTable = [null,_proc_exit,exitOnMainThread,pthreadCreateProxied,___syscall_fcntl64,___syscall_ioctl,___syscall_openat,_emscripten_get_preloaded_image_data,_emscripten_get_preloaded_image_data_from_FILE,_environ_get,_environ_sizes_get,_fd_close,_fd_read,_fd_seek,_fd_write];
